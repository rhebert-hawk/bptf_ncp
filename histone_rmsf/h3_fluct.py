...
y,yerr = np.loadtxt("Nucm_h3_2.dat", usecols=(1,2), unpack=True, comments=('#','@','&'))
f,y1,y1err = np.loadtxt("EnoB_h3_2.dat", usecols=(0,1,2), unpack=True, comments=('#','@','&'))
g,y2,y2err = np.loadtxt("NucE_h3_2.dat", usecols=(0,1,2), unpack=True, comments=('#','@','&'))
...
plt.tight_layout()
plt.title("Nucleosome H3 1-55 Fluctuations (No PTM)", fontweight='bold')
plt.savefig("h3_fluct.pdf", dpi=300)
plt.savefig("h3_fluct.svg")
#plt.show()
plt.close()
